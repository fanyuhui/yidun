#import "TextFlutterPlugin.h"

@implementation TextFlutterPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"text_flutter_plugin"
            binaryMessenger:[registrar messenger]];
  TextFlutterPlugin* instance = [[TextFlutterPlugin alloc] init];
